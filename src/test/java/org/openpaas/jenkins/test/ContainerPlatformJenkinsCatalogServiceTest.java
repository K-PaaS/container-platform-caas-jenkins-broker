package org.openpaas.jenkins.test;
...
import org.openpaas.container.platform.jenkins.common.CommonService;
import org.openpaas.container.platform.jenkins.config.BrokerConfig;
import org.openpaas.container.platform.jenkins.config.CatalogConfig;
import org.openpaas.container.platform.jenkins.config.GsonConfig;
import org.openpaas.container.platform.jenkins.config.RestTemplateConfig;
import org.openpaas.container.platform.jenkins.service.impl.ContainerPlatformJenkinsCatalogService;
import org.openpaas.container.platform.jenkins.service.impl.ContainerPlatformJenkinsInstanceService;
...
public class ContainerPlatformJenkinsCatalogServiceTest {
    ...
    public void getCatalog() throws Exception {
        ...
        ReflectionTestUtils.setField(catalogConfig, "SERVICEDEFINITION_DESC", "\"A kpaas source control service for application development.provision parameters : parameters {owner : owner}\"");
